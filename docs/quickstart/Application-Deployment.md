...
* 【名称】表示应用的名称，不可为空。同一个应用中的服务名称不可重复，包含相同服务名称的不用应用部署到同一个节点会导致其中一个部署报错
...
* 【名称】表示服务的名称，不可为空。同一个应用中的服务名称不可重复，包含相同服务名称的不用应用部署到同一个节点会导致其中一个部署报错
...
* 【名称】表示函数服务的名称，不可为空。同一个应用中的服务名称不可重复，包含相同服务名称的不用应用部署到同一个节点会导致其中一个部署报错
