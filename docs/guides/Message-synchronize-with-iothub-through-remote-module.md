...
- 您也可以通过 Baetyl 源码自行编译所需的 Hub 模块镜像和 Remote 模块镜像，具体请查看 [如何从源码构建镜像](../install/Build-from-Source.md)
...
![用于连接 Baidu IoT Hub 的 MQTT.fx 配置信息](../images/guides/remote/mqttfx-connect-hub-config1.png)

![用于连接 Baidu IoT Hub 的 MQTT.fx 配置信息](../images/guides/remote/mqttfx-connect-hub-config2.png)
...
![MQTT.fx 成功与 Baidu IoT Hub 建立连接](../images/guides/remote/mqttfx-connect-success.png)
